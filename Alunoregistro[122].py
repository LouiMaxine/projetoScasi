...
class Login(QDialog):
    def __init__(self, parent = None):
        ...
        layout.addWidget(self.btn_CadUsuario,8, 2)#localizar o botão
        font9 = self.btn_CadUsuario.font()#Recebendo a fonte do título
        font9.setBold(True)
    ...
    def cadastrodeusuario(self):
        ...
        try:
            if(self.nome_txt.text()=='' or self.senha_txt.text()== ''):
                QMessageBox.warning(self,"AVISO!", 'Os campos usuário e cadastro devem ser preenchidos para prosseguir.')
            else:
                conn = pymysql.connect("localhost","root","","registroalunos")#Vai no banco de dados
                cur= conn.cursor()#Pesquisa
                ...
                if resultado[0] !=1:
                    ...
                    QMessageBox.warning(self,'br07louise@hotmail.com','O Cadastro já foi realizado,\n preencha os campos com usuário e senha válidos e aperte em Login.')
